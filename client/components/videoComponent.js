...
export default class VideoComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      screenTrack: null, // new state fields to track screen sharing
      isScreenSharingEnabled: false // new state fields to track screen sharing
    }
  ...
  joinRoom() {
    /* 
    Show an error message on room name text field if user tries joining a room without providing a room name. 
  ...
  async componentDidMount() {
    let results = await axios.get('api/twilio/token')
    let {identity, token} = results.data
